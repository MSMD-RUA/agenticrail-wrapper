  ...
  await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      ...
      text: [
        ...
        ``,
        `Troubleshooting:`,
        `· Getting DENY? Check your step order. The gate enforces strict sequence.`,
        `· Getting SEQUENCE_VIOLATION? You may have skipped a step.`,
        `· Getting REPLAY_NONCE? Each step needs a unique nonce.`,
        `· Need a custom workflow? Use the Builder: https://agenticrail.nz/builder/`,
        ``,
